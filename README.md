...
| Create a semester                                                          | `POST`      | `/semesters`       | `token`                                                                                | :soon:                  |
| Update a semester                                                          | `PUT`       | `/semesters`       | `token`, `semesterId`                                                                  | :soon:                  |
| Delete a semester                                                          | `DELETE`    | `/semesters`       | `token`, `semesterId`                                                                  | :soon:                  |
...
| Get all lecturers                                                          | `GET`       | `/lecturers`       | `token`, optional [:parking:]: `experience`, `comment`, `extern`, `lastname`, `extern` | :ballot_box_with_check: |
...
| Create a major subject                                                     | `POST`      | `/majorSubjects`   | `token`                                                                                | :ballot_box_with_check: |
...
| Get all presentations for a given course                                   | `GET`       | `/presentations`   | `token`, `courseId`, optional: `semesterId`                                            | :soon:                  |
| Create a presentation                                                      | `POST`      | `/presentations`   | `token`                                                                                | :soon:                  |
| Update a presentation                                                      | `PUT`       | `/presentations`   | `token`, `presentationId`                                                              | :soon:                  |
| Delete a presentation                                                      | `DELETE`    | `/presentations`   | `token`, `presentationId`                                                              | :soon:                  |

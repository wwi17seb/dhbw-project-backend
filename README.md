...
| Register with register key                                                 | `POST`      | `/register`          |                                                                                          | :ballot_box_with_check: | [auth.md](/docs/apis/auth.md)                           |
| Change own password                                                        | `PUT`       | `/changePassword`    | `directorOfStudiesId`                                                                    | :ballot_box_with_check: | [directorOfStudies.md](/docs/apis/directorOfStudies.md) |
| Get all attributes to the current director of studies                      | `GET`       | `/directorOfStudies` | `token`                                                                                  | :ballot_box_with_check: | [directorOfStudies.md](/docs/apis/directorOfStudies.md) |
| Update the current director of studies                                     | `PUT`       | `/directorOfStudies` | `token`                                                                                  | :ballot_box_with_check: | [directorOfStudies.md](/docs/apis/directorOfStudies.md) |
| [Admin routes] Create new director of studies                              | `POST`      | `/createUser`        | `token`                                                                                  | :ballot_box_with_check: | [admin.md](/docs/apis/admin.md)                         |
| [Admin routes] Reset password of director of studies                       | `PUT`       | `/resetPassword`     | `token`, `directorOfStudiesId`                                                           | :ballot_box_with_check: | [admin.md](/docs/apis/admin.md)                         |
| [Admin routes] Give director of studies admin privileges                   | `PUT`       | `/upgradeToAdmin`    | `token`, `directorOfStudiesId`                                                           | :ballot_box_with_check: | [admin.md](/docs/apis/admin.md)                         |
| [Admin routes] Get register key                                            | `GET`       | `/registerKey`       | `token`                                                                                  | :ballot_box_with_check: | [admin.md](/docs/apis/admin.md)                         |
| [Admin routes] Update register key                                         | `PUT`       | `/registerKey`       | `token`                                                                                  | :ballot_box_with_check: | [admin.md](/docs/apis/admin.md)                         |

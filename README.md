...
| Get all presentations for a given course OR given lecturer                 | `GET`       | `/presentations`     | `token`, `courseId` OR `lecturerId`, optional: `semesterId`, `status`, `getCoLecturers`  | :white_check_mark:  | [presentations.md](/docs/apis/presentations.md)         |
| Create a presentation                                                      | `POST`      | `/presentations`     | `token`                                                                                  | :white_chesck_mark: | [presentations.md](/docs/apis/presentations.md)         |

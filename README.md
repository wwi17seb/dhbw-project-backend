...
| Get all presentations for a given course OR from a given lecturer                                  | `GET`       | `/presentations`   | `token`, `courseId` OR `lecturerId`, optional: `semesterId`                                              | :ballot_box_with_check: | [presentations.md](/docs/apis/presentations.md)     |
